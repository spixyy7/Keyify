...
const TRANSLATIONS = {
  ...
  sr: {
    ...
    /* — FOOTER — */
    footer: {
      tagline:    'Vaš pouzdani izvor originalnih digitalnih ključeva i pretplata po najboljim cenama.',
      shop:       'Prodavnica',
      support:    'Podrška',
      newsletter: 'Newsletter',
      newsletterDesc: 'Prijavite se za ekskluzivne popuste i obaveštenja o novim proizvodima.',
    ...
    checkout: {
      ...
      vatNote:        'Cena uključuje sve poreze i naknade.',
    },
    ...
    home: {
      ...
      heroSubtitle:  'Originalni ključevi za AI alate, softver i streaming po najboljim cenama na tržištu.',
      ...
      featuredSub:   'Najprodavanije licence po povoljnim cenama.',
    ...
    admin: {
      ...
      theme: {
        ...
        sub:          'Promene se odmah primenjuju na sajtu putem CSS varijabli.',
